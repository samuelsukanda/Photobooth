...
const BASE_URL = 'http://photobooth.test';
...
export default function () {
  group('GET /api/photos', function () {
    ...
    check(res, {
      ...
      'photos response has data': (r) => r.json('data') !== null,
    });
  });
  ...
  group('POST /api/photos', function () {
    ...
    check(res, {
      'upload accepted (201/422)': (r) => r.status === 201 || r.status === 422,
    });
  });
